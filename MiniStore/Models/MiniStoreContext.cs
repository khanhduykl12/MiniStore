...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => e.MAHD).HasName("PK__HDBAN__603F20CE633C244E");

            entity.HasOne(d => d.NGUOILAP).WithMany(p => p.HDBANNGUOILAPs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HDBAN__NGUOILAP___41D8BC2C");

            entity.HasOne(d => d.NGUOIMUA).WithMany(p => p.HDBANNGUOIMUAs)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK__HDBAN__NGUOIMUA___42CCE065");
        });
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__NGUOIDUN__3214EC2749F0AE8A");
        ...
        {
            entity.HasKey(e => e.ID).HasName("PK__OTP_LOG__3214EC274AC2A857");
