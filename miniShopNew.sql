...
create table NGUOIDUNG(
    ...
    CONSTRAINT FK_NGUOIDUNG_VAITRO FOREIGN KEY(MAROLE) REFERENCES VAITRO(MAROLE)
)
CREATE TABLE HDBAN (
...
CREATE TABLE HDNHAP (
    ...
    CONSTRAINT FK_HDNHAP_TAIKHOAN FOREIGN KEY(USERNAME) REFERENCES TAIKHOAN(USERNAME)
...
VALUES
(N'user1', N'Nguyễn Văn A', '1991-02-02', N'Nữ', N'TP HCM', N'0987078703', N'Nhân viên', 8188356, NULL, N'NV'),
...
(N'user5', N'Nguyễn Văn Hùng', '1995-06-06', N'Nam', N'TP HCM', N'0986860819', N'Quản trị viên',16491246, NULL, N'ADMIN'),
(N'user6', N'Lê Văn Sáu', '1996-07-07', N'Nữ', N'Bến Tre', N'0947579947', NULL, NULL, 140, N'KH'),
(N'user7', N'Hoàng Thị Bảy', '1997-08-08', N'Nữ', N'TP HCM', N'0934596373', N'Quản trị viên',16491246, NULL, N'ADMIN'),
(N'user8', N'Lê Thị Hoa', '1998-09-09', N'Nữ', N'TP HCM', N'0911499415', N'Nhân viên', 9781464, NULL, N'NV'),
(N'user9', N'Phạm Minh Anh', '1999-10-10', N'Nữ', N'TP HCM', N'0972307040', N'Quản trị viên', 6630412, NULL, N'ADMIN'),
...
INSERT INTO HDBAN (MAHD, NGAYLAP, NGUOILAP_ID, NGUOIMUA_ID, GHICHU) VALUES
(N'HDB11', '2024-04-28', 2, 7, N'Ghi chú hóa đơn bán 11');
...
INSERT INTO CHITIETHDNHAP (MAHDNHAP, MASP, SOLUONGTN, DONGIANHAP, GHICHU) VALUES
(N'HDN7', N'SP007', 11, 49530, N'Ghi chú nhập 11');
...
--Xóa hóa đơn mà không có chi tiết hóa đơn
go
CREATE TRIGGER TRG_DeleteEmptyInvoice
ON CHITIETHDBAN
AFTER INSERT, DELETE
AS
BEGIN
    -- Xóa hóa đơn không có chi tiết
    DELETE FROM HDBAN
    WHERE MAHD NOT IN (SELECT DISTINCT MAHD FROM CHITIETHDBAN);
END
-----Stored Procedure---
